...
[group("clean")]
clean-cache: && (_clean ".dmypy.json" ".pytype" "tuna-loadtime.log") (find_and_clean "." ".*_cache")
...
[group("clean")]
clean-pyc: (_clean ".numba_cache/*") (find_and_clean "." "__pycache__") (find_and_clean "." "*.pyc" "*.pyo" "*.nbi" "*.nbc")
